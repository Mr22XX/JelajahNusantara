...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 p-5 dark:text-white transition duration-300">
      <Navbar/>
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div className="bg-blue-50 dark:bg-blue-950 p-6 rounded-lg shadow-md">
